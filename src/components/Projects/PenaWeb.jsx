    ...
    <Template title='PENA Website 2022-2023' subtitle='Company Profile'  >
      <div style={{ backgroundImage: `url(${webPenaCover})` }} className='p-8 bg-blue-950 bg-contain bg-no-repeat bg-right-bottom'>
        ...
        <p className='text-sm font-light w-full md:w-2/3 lg:w-1/3 mt-8 text-justify'>
          This website contains various content such as a brief explanation of the organization, names and positions of core management, vision and mission as well as a registration form for prospective new members.
        </p>
        ...
        <p className='text-sm font-light mb-8 capitalize'>Frontend Developer</p>
      ...
      <div className='text-gray-800 bg-white p-8'>
        ...
        <Text>
          PENA (Programming, Engineering and Networking Adhi Guna) PENA is an internal campus student organization that operates in the technology sector, this website was created in September 2022.
        </Text>
        <Text>
          The development of this website was carried out with the team, I acted as a frontend developer whose job was to create the user interface. while the backend is done using Laravel. An example of the user interface display on this website can be seen 
          <a href="https://pena-web.fandijsx.repl.co/" target='_blank' className='text-blue-600 hover:underline'> via this link.</a>
        </Text>
      </div>
